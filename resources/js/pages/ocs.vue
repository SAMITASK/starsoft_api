...
const status = ref([
  ...
  { title: "REC. PARCIALMENTE", value: "REC. PARCIALMENTE", color: "warning" },
  { title: "REC. TOTALMENTE", value: "REC. TOTALMENTE", color: "success" },
  { title: "LIQUIDADA", value: "LIQUIDADA", color: "info" },
  { title: "ANULADA", value: "ANULADA", color: "error" },
]);
